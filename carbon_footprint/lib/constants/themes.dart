...
ThemeData appTheme = ThemeData(
  ...
  textTheme: TextTheme(
    ...
    headline3: GoogleFonts.lobster(
      color: kTextColor,fontSize: 34
    ),
    bodyText1: GoogleFonts.ptSerif(
      color: kTextColor.withOpacity(0.8),fontSize: 15,fontWeight: FontWeight.bold
    ),
    ...
    headline4: GoogleFonts.ptSerif(
      color: kPrimeColor.withOpacity(0.9),fontSize: 30,fontWeight: FontWeight.bold
    ),
